#!/usr/bin/env python3
"""
The Definition of _hash_password function
"""
import bcrypt
...
def _hash_password(password: str) -> bytes:
    """
    It Hashes a password string and returns it in bytes form
    Args:
...
def _generate_uuid() -> str:
    """
    To Generate a uuid and return its string representation
    """
    return str(uuid4())


class Auth:
    """It Auth class to interact with the authentication database.
    """
    ...
    def register_user(self, email: str, password: str) -> User:
        """
        It Register a new user and return a user object
        Args:
    ...
    def create_session(self, email: str) -> Union[None, str]:
        """
        To Create a session_id for an existing user and update the user's
    ...
    def destroy_session(self, user_id: int) -> None:
        """
       It  Take a user_id and destroy that user's session and update their

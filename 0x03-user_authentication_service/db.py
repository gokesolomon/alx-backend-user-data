...
class DB:
    ...
    def __init__(self) -> None:
        """To Initialize a new DB instance
        """
    ...
    def add_user(self, email: str, hashed_password: str) -> User:
        """
        To Create a User object and save it to the database
        Args:
    ...
    def find_user_by(self, **kwargs) -> User:
        """
        To Return a user who has an attribute matching the attributes passed
        as arguments
        Args:

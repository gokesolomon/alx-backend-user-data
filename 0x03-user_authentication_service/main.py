...
def register_user(email: str, password: str) -> None:
    """
    To Test for register a user with the given email and password.
    Args:
...
def log_in_wrong_password(email: str, password: str) -> None:
    """
    To Test for log in with the given wrong credentials.
    Args:
        email: The email of the user.
        password: The password of the user.
    Returns:
...
def profile_unlogged() -> None:
    """
    To Test for profile without being logged in with session_id.
    Returns:
        None
    """
...
def log_in(email: str, password: str) -> str:
    """
    To Test for log in with the given correct email and password.
    Args:
        email: The email of the user.
        password: The password of the user.
    Returns:
...
def log_out(session_id: str) -> None:
    """
    To Test for log out with the given session_id.
    Args:
        session_id: The session_id of the user.
    Returns:
        None
...
def reset_password_token(email: str) -> str:
    """
    To test for reset password token with the given email.
    Args:
        email: The email of the user.
    Returns:
...
def update_password(email: str, reset_token: str,
    ...
    """
    To test for update password with the given email,

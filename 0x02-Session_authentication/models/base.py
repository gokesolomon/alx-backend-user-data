...
class Base():
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """ To Convert the object a JSON dictionary
        """
        result = {}
